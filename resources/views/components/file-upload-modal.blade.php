        ...
        <div class="modal-content">
            ...
            <div class="modal-body mx-auto">
                <div class="p-2 rounded shadow d-inline-flex flex-wrap bg-primary-10">
                    ...
                    <div class="my-auto me-2" id="fileIconImage">
                    ...
                    <div class="my-auto me-2" id="fileIconTxt">
                    ...
                    <div class="my-auto me-2" id="fileIconOther">
                        <svg height="32px" width="32px" fill="#ffffff" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff"><g id="SVGRepo_bgCarrier" stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier"><path d="M16,2l4,4H16ZM14,2H5A1,1,0,0,0,4,3V21a1,1,0,0,0,1,1H19a1,1,0,0,0,1-1V8H14Z"></path></g></svg>
                    </div>
            ...
            <form action="" method="post" enctype="multipart/form-data">
                ...
                <div class="modal-footer">
                    <button type="submit" id="uploadBtn" class="btn btn-primary w-100">Upload File</button>
                </div>
            </form>
        </div>
    </div>
...
<script>
    ...
    document.getElementById('fileInput').addEventListener('change', () => {setTimeout(function() {
        ...
        var fileIconImage = document.getElementById('fileIconImage');
        var fileIconTxt = document.getElementById('fileIconTxt');
        ...
        fileIconImage.classList.add('d-none');
        fileIconTxt.classList.add('d-none');
        ...
        switch (extension) {
            ...
            case 'PDF':
                ...
                break;
            case 'PNG':
                fileIconImage.classList.remove('d-none');
                break;
            case 'JPG':
                fileIconImage.classList.remove('d-none');
                break;
            case 'JPEG':
                ...
                break;
            case 'TXT':
                fileIconTxt.classList.remove('d-none');
                break;
            default:
