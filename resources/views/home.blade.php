        ...
        <a class="hover-5 row project-item mx-0 px-0 my-2 text-decoration-none text-dark" href="{{Route('project', $item->id)}}">
            <div class="col-4 p-0">
                <div class="d-flex flex-row mx-0 w-100 h-100 px-0">
                    ...
                    {{-- <div style="width:7em; height:5.5em; overflow:hidden;">
                        <img class="img-fluid" style="min-width:100%; transform: scale(2) translateX(0em) translateY(0.7em);" src="{{ asset($item->projectWallpaperURL) }} ">
                    </div> --}}
