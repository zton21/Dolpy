...
<body>
    ...
    <div class="container bg-warning">
        <div class="row fs-2 w-100">
            <div class="col-12 d-flex flex-row my-2" style="font-weight:600">
        ...
        <div class="row text-neutral-50 w-100 bg-primary-10 py-1 table-header">
        ...
        @foreach ($projects as $item)
            <div class="row project-item">
                <div class="col-4 p-0 py-2">
                    <div class="d-flex flex-row mx-0 w-100 h-100">
                ...
                <div class="col-2">{{$item->projectDueDate}}</div>
