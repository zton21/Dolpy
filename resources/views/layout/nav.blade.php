            ...
            <ul class="navbar-nav align-items-center gap-2">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#" role="button" id="notificationDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                        <svg class="" width="26px" height="26px" viewBox="0 0 24 24" fill="none" stroke="#1D1D1D" xmlns="http://www.w3.org/2000/svg" id="SVGRepo_notif" ><g stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
