        ...
        <div class="d-flex flex-row">
            <ul class="navbar-nav align-items-center gap-3">
                <li class="nav-item flex-col text-center">
                    <a class="nav-link {{ $chatsActive ?? "" }} inactive pnav" href="{{ route('project', $project->id) }}">
                ...
                <li class="nav-item flex-col text-center">
                    <a class="nav-link {{ $timelineActive ?? "" }} inactive pnav" href="{{ route('timeline', $project->id) }}">
                ...
                <li class="nav-item flex-col text-center">
                    <a class="nav-link {{ $filesActive ?? "" }} inactive pnav" href="{{ route('files', $project->id) }}">
                ...
                <li class="nav-item flex-col text-center">
                    <a class="nav-link {{ $peopleActive ?? "" }} inactive pnav" href="{{ route('member', $project->id) }}">
            ...
            <ul class="navbar-nav align-items-center gap-2">
                <li class="nav-item">
                    <a class="nav-link" href="{{ route('faq') }}">
                        <svg width="30px" height="30px" viewBox="0 0 24.00 24.00" fill="#1D1D1D" xmlns="http://www.w3.org/2000/svg" id="SVGRepo_faq"><g stroke-width="0"></g><g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g><g id="SVGRepo_iconCarrier">
