                            ...
                            <a class="text-decoration-none text-dark" href="?topic={{$loop->index}}">
                                <div class="row d-flex align-items-start px-3 topic">
                                    ...
                                    <div class="col-5 d-flex flex-row gap-2 align-items-center justify-content-end">
                                        <img src="{{ asset('storage/' . $item->profileURL) }}" alt="Profile Picture" class="img-fluid rounded-circle" style="width: 40px; height: 40px;">
                                ...
                                <div class="row d-flex align-items-center justify-content-between px-3 pb-2">
                                    <div class="col-12 d-flex flex-row align-items-center gap-2">
                                        <img src="{{ asset('storage/' . $item->profileURL2) }}" alt="Profile Picture" class="img-fluid rounded-circle" style="width: 40px; height: 40px;">
                                ...
                                <div class="row d-flex align-items-center justify-content-between px-3 pb-2">
                                    <div class="col-12 d-flex flex-row align-items-center gap-2">
                                        <img src="{{ asset('img/profilePicture.png') }}" alt="Profile Picture" class="d-none img-fluid rounded-circle" style="width: 40px; height: 40px;">
