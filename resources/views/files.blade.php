        ...
        <div class="row h-100">
                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="row m-0 py-3 justify-content-between">
                        ...
                        <div class="col-auto com-sm-3">
                            <button onclick="openAddFileSectionFormModal()" class="btn btn-primary">
            ...
            <div class="col-7 h-100 border p-0">
                <div class="container-fluid p-0 h-100">
                    ...
                    <hr class="p-0 my-0">
                    <div class="d-flex flex-column p-2 h-75 overflow-y-auto" style="background: #F3F8FE;">
                        <div class="d-flex flex-row align-items-center gap-2 mx-3 my-2">
                            ...
                            <div class="d-flex flex-column">
                                ...
                                <img src="{{URL::asset('img/profilePicture.png')}}" alt="image" class="p-2 bg-white rounded shadow flex-wrap"> 
                            </div>
                        </div>
